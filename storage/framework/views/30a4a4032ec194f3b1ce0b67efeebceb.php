...
<div class="page-card" style="max-width:980px; margin:30px auto; padding:30px;">
    ...
    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap:16px;">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="dash-btn" style="margin:0; text-align:center; padding:18px 16px;">Manage Users</a>
        <a href="<?php echo e(route('chat')); ?>" class="dash-btn" style="margin:0; text-align:center; padding:18px 16px;">Group Chat</a>
        ...
        <a href="<?php echo e(route('groups.manage')); ?>" class="dash-btn" style="margin:0; text-align:center; padding:18px 16px;">Manage groups</a>
    </div>

</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\forum-backend\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>