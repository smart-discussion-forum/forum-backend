...
<div class="page-card" style="max-width: 960px; margin: 0 auto; padding: 32px; border-radius: 30px;">
    ...
    <?php if(session('success')): ?>
        <div class="success" style="margin-bottom: 16px;"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
            ...
            <?php $__currentLoopData = $myGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="panel">
                    <div class="row" style="align-items: center;">
                        ...
                        <form method="POST" action="<?php echo e(route('groups.leave', $group->id)); ?>">
                            <?php echo csrf_field(); ?>
                ...
                <div class="panel">
                    <div class="row" style="align-items: center;">
                        ...
                        <?php if(auth()->user()->role === \App\Enums\RoleEnum::Student): ?>
                            <form method="POST" action="<?php echo e(route('groups.join', $group->id)); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\forum-backend\resources\views/groups/index.blade.php ENDPATH**/ ?>