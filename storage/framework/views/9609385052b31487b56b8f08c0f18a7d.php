...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\forum-backend\resources\views/auth/register.blade.php ENDPATH**/ ?><?php $__env->startSection('content'); ?>
    <div class="auth-card" style="max-width:480px; margin:48px auto; padding:30px;">
        <div class="screen-title" style="margin-bottom:6px; font-size:26px;">Registration</div>
        <p style="text-align:center; color:var(--muted); margin-top:0; margin-bottom:22px;">Create your account and join a discussion group.</p>
        <form method="POST" action="/register">
...
unset($__errorArgs, $__bag); ?>
            ...
            <select name="group_ids[]" required>
                <option value="">Select a group</option>
                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($group->id); ?>" <?php if(in_array($group->id, old('group_ids', []))): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <label><input type="checkbox" name="accepted_terms" value="1" style="width:auto;" <?php if(old('accepted_terms')): echo 'checked'; endif; ?> required> Accept Rules</label>
            <?php $__errorArgs = ['accepted_terms'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
