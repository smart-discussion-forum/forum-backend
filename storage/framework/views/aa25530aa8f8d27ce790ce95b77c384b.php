...
<?php /**PATH C:\Users\LENOVO\Documents\forum-backend\resources\views/layouts/app.blade.php ENDPATH**/ ?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="navbar">
        <?php if(auth()->guard()->check()): ?>
            ...
            <div style="color:white; display:flex; align-items:center; gap:15px;">
                <span><?php echo e(auth()->user()->name); ?> (<?php echo e(ucfirst(auth()->user()->role->value)); ?>)</span>
...
<?php /**PATH C:\Users\LENOVO\Documents\forum-backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>