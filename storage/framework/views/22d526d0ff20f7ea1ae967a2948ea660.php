<?php $__env->startSection('content'); ?>
    <div class="page-card" style="max-width:980px; margin:30px auto; padding:30px;">
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap:16px;">
            ...
            <a href="<?php echo e(route('groups.statistics', auth()->user()->groups()->first()?->id ?? 1)); ?>" class="dash-btn" style="margin:0; text-align:center; padding:18px 16px;">Statistics</a>
            <a href="/profile" class="dash-btn" style="margin:0; text-align:center; padding:18px 16px;">Profile</a>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PILOT\Desktop\forum-backend\resources\views/dashboard.blade.php ENDPATH**/ ?>